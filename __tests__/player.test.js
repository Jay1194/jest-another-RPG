...
//shows how to create a new test that verifies that a player's attack value is within range
...
//usePotion() removes the correct Potion from the Player inventory
